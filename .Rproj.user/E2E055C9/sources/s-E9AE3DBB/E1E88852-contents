...
int_wet_all <- function(data){

  int_wet <- c('ICH wk 1' , 'ICH wk 2' , 'ICH wk 3' , 'ICH wk 4' , 'ICH vk 1' ,
               'ICH vk 2', 'ICH mw 1' , 'ICH mw 2' , 'ICH mw 3' , 'ICH mw 4' ,
               'ICH mw 5', 'ESSFmh', 'ESSFwk 1', 'ESSFwk 2', 'ESSFvc', 'ESSFvcw',
               'ESSFwc 2' , 'ESSFwc 3' , 'ESSFwc 4' , 'ESSFwcw' , 'ESSFwh 1' ,
               'ESSFwh 2' , 'ESSFwh 2' , 'ESSFwh 3' , 'ESSFwm 1' , 'ESSFwm 2' ,
               'ESSFwm 3' ,  'ESSFwmw' , 'ICH mk 4', 'ESSFwm 4' , 'ESSFmm 3' , 'ESSFmmw' ,
               'ICH dw 1' , 'ICH dw 3' ,'ICH dw 4' , 'ICH mk 1' , 'ICH mk 2' , 'ICH mk 3',
               'ICH mk 5' , 'ICH mm')


  output <- data %>%
    filter(BGC_LABEL %in% int_wet)

  output
}

int_tran <- function(data){

  int_transitional <- c('ESSFwm 4' , 'ESSFmm 3' , 'ESSFmmw' , 'ICH dw 1' , 'ICH dw 3' ,
                      'ICH dw 4' , 'ICH mk 1' , 'ICH mk 2' , 'ICH mk 3',  'ICH mk 5' , 'ICH mm')
  output <- data %>%
    filter(BGC_LABEL %in% int_transitional)
  output
}

int_itr <- function(data){

  int_itr <- c('ICH wk 1' , 'ICH wk 2' , 'ICH wk 3' , 'ICH wk 4' , 'ICH vk 1' , 'ICH vk 2' )

  output <- data %>%
    filter(BGC_LABEL %in% int_itr)
  output
}

int_iwb <- function(data){

  int_iwb <- c('ICH mw 1' , 'ICH mw 2' , 'ICH mw 3' , 'ICH mw 4' , 'ICH mw 5', 'ESSFmh',
               'ESSFwk 1', 'ESSFwk 2', 'ESSFvc', 'ESSFvcw', 'ESSFwc 2' , 'ESSFwc 3' ,
               'ESSFwc 4' , 'ESSFwcw' , 'ESSFwh 1' , 'ESSFwh 2' , 'ESSFwh 2' , 'ESSFwh 3' ,
               'ESSFwm 1' , 'ESSFwm 2' , 'ESSFwm 3' ,  'ESSFwmw' , 'ICH mk 4' )
  output <- data %>%
    filter(BGC_LABEL %in% int_iwb)
  output
}
...
filter_og_dependent <- function(data){
